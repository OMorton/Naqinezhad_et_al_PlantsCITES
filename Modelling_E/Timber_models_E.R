...
## Read in Data
CITES_IUCN_Timber_E<- data.table::fread ("Outputs/Data_preparation_E/Timber/CITES_IUCN_Timber_E.csv", na.strings = "")%>% select(-V1)
...
hist(CITES_IUCN_Timber_E$Vol)
max(CITES_IUCN_Timber_E$Vol)


HG_5_E <- brm(bf(Vol ~ 1 + Clean_code + Clean_code:SYear + SYear +
            ...
            data = CITES_IUCN_Timber_E,
            file="Outputs/Models_E/Timber/HG_5_E.rds",
            chains = 4, iter = 1000, thin = 1, cores = 4, warmup = 500)

summary (HG_5_E)
prior_summary(HG_5_E)
